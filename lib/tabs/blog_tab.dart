...
import 'package:flutter_app4/providers/api_provider.dart';
import 'package:flutter_app4/widgets/blog_widget.dart';
import 'package:flutter_app4/widgets/responsive_widget.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              elevation: 0.0,
              onPressed: () =>
                  html.window.open(Constants.PROFILE_MEDIUM, 'RahulTilwani'),
            )
          ],
        ),
      ),
